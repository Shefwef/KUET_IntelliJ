...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  ...
  return (
    <div
    className="sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer transition-transform transform hover:scale-110 duration-300 ease-in-out hover:bg-[#6a0dad]" 
    onClick={handleClick}
  >
